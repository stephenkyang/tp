...
public class HelpCommand extends Command{
    ...
    public static void showCommands(){
        ...
        System.out.println("1. Budget - choose how much money you want to allocate to a budget of your specified name.");
        System.out.println("2. Expense - track how much money you have spent, and link it to a certain budget of yours");
        System.out.println("3. Deposit - track how much money you have earned or received\n");
